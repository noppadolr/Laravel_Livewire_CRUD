                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-brand">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset('admin/assets/images/logo-dark.pn') }}g" alt="" height="22">
                                            </span>
                                        </a>
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('username')
                                            is-invalid @enderror" type="text" name="username" id="username" placeholder="Enter your username">
                                        @error('username')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            is-invalid @enderror" placeholder="Enter your password">
